...
import theme2 from '../../src/image2/theme2.jpg';
...
function PTPM() {
  ...
  return (
    ...
    <Header/>
           ...
           <img fetchpriority="high" decoding="async" width="2500" height="1042" src={theme2} alt="" sizes="(max-width: 2500px) 100vw, 2500px"/>
           </div>
...
<section className="image-grid-custom22">
  <div className="image-container-custom22">
	...
	<p>
      ...
      <br />
      <span>-Cơ sở lập trình <br />-Toán ứng dụng cho Tin học<br/>
      -Mạng máy tính căn bản<br/>
  ...
  <div className="image-container-custom22">
    ...
    <div className='textabout'>
	<p>
      <span>-Kỹ thuật lập trình<br />
	  -Lập trình hướng đối tượng<br/>
	  -Ngôn ngữ lập trình C#/Java/PHP<br/>
      -Cơ sở dữ liệu<br/>
      -Đồ án 1
	  </span>
    </p>
...
<section className="image-grid-custom22">
  <div className="image-container-custom22">
	...
	<div className="textabout">
	<p>
      <span>-Cấu trúc dữ liệu và giải thuật <br/>-Lập trình Web 1</span>
      <br />
      <span>-Thiết kế Web 1<br/> -Nhập môn Công nghệ phần mềm</span>
    </p>
	</div>
  ...
  <div className="image-container-custom22">
    ...
    <div className='textabout'>
	<p>
      <span>-Thiết kế Web 2<br/>
		-Lập trinhg Web 2<br/>
		-Phân tích và thiết kế phần mềm<br/>
...
<section className="image-grid-custom22">
  <div className="image-container-custom22">
	...
	<div className="textabout">
	<p>
      <span>-Nhập môn Trí tuệ nhân tạo<br/>
            -Kỹ thuật nghề nghiệp<br/>
             -Lập trình web 3<br/>
             -Bảo mật Web và ứng dụng<br/>
             -Đồ án 3</span>
    </p>
	</div>
